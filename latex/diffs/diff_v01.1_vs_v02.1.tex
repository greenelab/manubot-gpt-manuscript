...
%DIF DEL diffs/v01.1.tex   Tue Jan  2 06:25:04 2024
%DIF ADD diffs/v02.1.tex   Tue Jan  2 06:25:04 2024
...
\DIFaddbegin \DIFadd{Our tool allows the user to provide a custom prompt instead of using the default ones shown here}.}\label{fig:ai_revision}
}
...
\DIFaddbegin \DIFadd{Single words are not underlined/highlighed in this case because the revision completely overhauled the text}.}\label{fig:abstract:ccc}
}
\DIFaddendFL \end{figure}
...
Original text is on the left and suggested revision on the right.
\DIFaddbegin \DIFadd{Single words are not underlined/highlighed in this case because the revision completely overhauled the text}.}\label{fig:results:ccc}
}
\DIFaddendFL \end{figure}
...
\DIFadd{The manuscripts' text used for evaluation in this article are available on their GitHub repositories, at }\url{https://github.com/greenelab/ccc-manuscript}\DIFadd{, }\url{https://github.com/greenelab/phenoplier_manuscript} \DIFadd{and }\url{https://github.com/greenelab/manubot-gpt-manuscript}\DIFadd{.
The source code of the Manubot AI Editor is available on GitHub, at }\url{https://github.com/manubot/manubot-ai-editor}\DIFadd{.
}
