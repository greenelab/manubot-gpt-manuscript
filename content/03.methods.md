...
We requested the Manubot maintainers to incorporate our workflow as part of the standard template manuscript (called rootstock, and available at [https://github.com/manubot/rootstock](https://github.com/manubot/rootstock)).
