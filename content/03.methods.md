...
We have [contributed our workflow](https://github.com/manubot/rootstock/pull/484) to the standard Manubot template manuscript, which is called rootstock and available at [https://github.com/manubot/rootstock](https://github.com/manubot/rootstock)).
The PR where this work is being done is: ([https://github.com/manubot/rootstock/pull/484](https://github.com/manubot/rootstock/pull/484)).
Meanwhile, any Manubot-based manuscript can be revised using our tool by following the PR instructions and copy the workflow file and the set of required scripts into the GitHub repository of the manuscript.
