...
The revision for the abstract of CCC is shown in Figure @fig:abstract:ccc.
...
The revision for the first paragraph of the introduction of CCC is shown in Figure @fig:intro:ccc.
...
In Figure @fig:results:ccc, we show a paragraph of the Results section of CCC describing a set of simulations using different datasets shown in Figure 1 of [@doi:10.1101/2022.06.15.496326].
...
An example of this is shown in Figure @fig:results:phenoplier, where we describe our CRISPR screening approach to assess whether top genes in a latent variable (LV) could represent good therapeutic targets.
...
In Figure @fig:discussion:ccc, we show a paragraph of CCC where we discuss how not-only-linear correlation coefficients could potentially impact genetic studies of complex traits.
...
In Figure @fig:methods:phenoplier, we show the revision of a paragraph in PhenoPLIER that contains two numbered equations.
